...
class SeniorExec extends Component {
          ...
          this.setState(
            ...
            () => {
              this.setState(
                {
                  meetingDates: {
                    ...this.state.meetingDates,
                    ONE_ON_ONE_FQY: this.state.oneOnOneFrequency,
                  },
                },
                () => {
                  this.setState(
                    {
                      meetingDates: {
                        ...this.state.meetingDates,
                        ONE_ON_ONE: this.state.oneOnOneDates,
                      },
                    },
                    () => {
              ...
              this.setState(
                {
                  meetingDates: {
                    ...this.state.meetingDates,
                    FOUR_ON_ONE_FQY: this.state.fourOnOneFrequency,
                  },
                },
                () => {
                  this.setState(
                    {
                      meetingDates: {
                        ...this.state.meetingDates,
                        FOUR_ON_ONE: this.state.fourOnOneDates,
                      },
                    },
                    () => {
              ...
              this.setState(
                {
                  meetingDates: {
                    ...this.state.meetingDates,
                    MOCK_INTERVIEW_FQY: this.state.mockInterviewFrequency,
                  },
                },
                () => {
                  this.setState(
                    {
                      meetingDates: {
                        ...this.state.meetingDates,
                        MOCK_INTERVIEW: this.state.mockInterviewDates,
                      },
                    },
                    () => {
      ...
      this.setState(
        ...
        () => {
          this.setState(
            {
              oneOnOneDates: [
                ...this.state.oneOnOneDates,
                { id: event.target.id, date: value },
              ],
            },
            () => {
              this.setState(
  ...
  handleMockMeetingDatesChange = (event) => {
    ...
    if (
      this.state.mockInterviewDates.some((date) => date.id === event.target.id)
    ) {
      let dates = [...this.state.mockInterviewDates];
      let index = findDate(dates, "id", event.target.id);
      dates.splice(index, 1);
      ...
      <Container component="main" maxWidth="lg">
        <Grid container spacing={2} alignItems="center" justify="center">
          <div className={classes.form}>
            <Tooltip>
              <b className={classes.chatTypeText}>
                Please Select the types of meeting you will be available for:
              </b>
            </Tooltip>
            <Grid item xs={12}>
              <FormControlLabel
                control={
                  <Checkbox checked={this.state.oneOnOne} name="checkedD" />
                }
                label={
                  <Tooltip>
                    <b>1 On 1</b>
            ...
            <Grid container item xs={12} alignItems="center" justify="center">
              <Grid item xs={12} sm={3}>
                <TextField
                  ...
                  fullWidth
                  select
                  label="Number of 1-on-1 Chats per year (Optional)"
            ...
            <Grid
              ...
              justify="center"
            >
              {[...Array(this.state.oneOnOneFrequency)].map(
            ...
            {this.state.mockInterview && (
              <div>
                ...
                >
                  <Grid item xs={12} sm={3}>
                    <TextField
                      ...
                      fullWidth
                      select
                      label="Number of Mock Interviews per year (Optional)"
                ...
                <Grid
                  ...
                  justify="center"
                >
                  {[...Array(this.state.mockInterviewFrequency)].map(
                    (elementInArray, index) => (
                      <Grid
                        item
                        xs={6}
            ...
            {this.state.fourOnOne === true && (
              <div>
                ...
                >
                  <Grid item xs={12} sm={3}>
                    <TextField
                      ...
                      fullWidth
                      select
                      label="Number of 4-on-1 Chats per year (Required)"
                ...
                <Grid
                  ...
                  justify="center"
                >
                  {[...Array(this.state.fourOnOneFrequency)].map(
                    (elementInArray, index) => (
                      <Grid
                        item
                        xs={6}
