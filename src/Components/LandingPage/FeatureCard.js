      ...
      <ReactCardFlip isFlipped={this.state.isFlipped} flipDirection="vertical">
        ...
        >
          <img
            ...
            src={tint}
            alt="Tint on front of feature card"
          />
          <img
            style={{
              width: "100%",
            ...
            src={this.state.images[this.props.card_number - 1]}
            alt="Front of feature card"
          />
        ...
        >
          <img
            ...
            src={tint}
            alt="Tint on back of feature card"
          />
          <img
            style={{
              width: "100%",
